...
# The uploader ships exactly one archive so this end does not have to guess how
# Kaggle chose to expand the upload.
os.makedirs(WORK, exist_ok=True)
archive = os.path.join(SRC, "code.zip")
if not os.path.isfile(archive):
    raise SystemExit("expected " + archive + ", found: " + str(os.listdir(SRC)))
